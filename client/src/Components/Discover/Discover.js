  ...
  return (
    <div>
      <div className="discover-container">
        <h1> Welcome to discover! Here we'll show you a random recipe from our library. If you don't feel like making this one, no worries! Just click the button below and we'll show you another one</h1>
